<%-- 
    Document   : MeusChamados
    Created on : 22 de nov. de 2024, 21:45:48
    Author     : danie
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            lista = usuDAO.Chamados(nome, senha);
            
            if (lista == null || lista.isEmpty()) {
            %>
            <div class="alert">Nenhum chamado aberto.</div>
            <div class="button-group">
                <a href="../destino.html" class="btn">Voltar</a>
            </div>
            <%
            } else {
            %>
            <table>
                ...
                %>
                    <tr>
                        ...
                        <td><%= resultadoDataFim %></td>
                        <td>
                            <div class="button-group">
                                <a href="../Editar/editar.jsp?id=<%= chamado.getId() %>" class="btn">Editar</a>
                                <a href="../Excluir/excluir.jsp?id=<%= chamado.getId() %>" class="btn btn-danger">Excluir</a>
                            </div>
                        </td>
                    </tr>
